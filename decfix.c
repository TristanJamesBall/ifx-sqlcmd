...
@(#)Last changed:   $Date: 2016/01/18 03:13:17 $
@(#)Purpose:        Fixed formatting of DECIMALs
@(#)Author:         J Leffler
@(#)Copyright:      (C) JLSS 1991-93,1996-97,1999,2001,2003,2005,2007-08,2016
...
extern const char jlss_id_decfix_c[];
const char jlss_id_decfix_c[] = "@(#)$Id: decfix.c,v 3.18 2016/01/18 03:13:17 jleffler Exp $";
#endif /* lint */
