...
@(#)Last changed:   $Date: 2013/06/04 00:19:59 $
@(#)Purpose:        POSIX-compliant cover for <sys/stat.h> for Windows
@(#)Author:         J Leffler
@(#)Copyright:      (C) JLSS 1995,1997,2001,2005,2008,2013
...
const char jlss_id_sysstat_h[] = "@(#)$Id: sysstat.h,v 1.9 2013/06/04 00:19:59 jleffler Exp $";
#endif /* lint */
#endif /* MAIN_PROGRAM */
