/*
@(#)File:           $RCSfile: emalloc.c,v $
@(#)Version:        $Revision: 5.13 $
@(#)Last changed:   $Date: 2016/01/17 16:05:58 $
...
extern const char jlss_id_emalloc_c[];
const char jlss_id_emalloc_c[] = "@(#)$Id: emalloc.c,v 5.13 2016/01/17 16:05:58 jleffler Exp $";
#endif /* lint */
