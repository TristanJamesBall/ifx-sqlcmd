...
@(#)Last changed:   $Date: 2015/02/17 04:50:35 $
...
extern const char jlss_id_emalloc_h[];
const char jlss_id_emalloc_h[] = "@(#)$Id: emalloc.h,v 5.10 2015/02/17 04:50:35 jleffler Exp $";
#endif /* lint */
#endif /* MAIN_PROGRAM */
